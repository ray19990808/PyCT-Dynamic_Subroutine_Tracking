...
class TokenizerUtilsTest(unittest.TestCase):
    ...
    def test_padding_accepts_tensors(self):
        ...
        # if os.environ['run_pyct_in_unittest'] == 'True':
        #     from arg_wrapper.arg_wrapper import unit_test_run_pyct
        #     unit_test_run_pyct(tokenizer.pad, tokenizer, features, padding=True, return_tensors="np")
