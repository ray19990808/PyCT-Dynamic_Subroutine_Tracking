...
def pyct_test_transformers(file, funcname, in_dict,logfile=None,_func=None):
    """
    params example:
    ...
    run_explore_one_func_no_coverage(rootdir, file, funcname, lib, TOTAL_TIMEOUT , verbose, in_dict,logfile=logfile,func=_func)
