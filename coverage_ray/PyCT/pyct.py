...
if __name__ == '__main__':
    ...
    res = engine.explore(args.modpath, eval(args.input), root=args.root, funcname=args.func,
...
def run(root, modpath, funcname, in_dict, lib,
        dump_projstats=True, include_exception=True, statsdir='pyctlog',
        max_iter=0, single_timeout=600, timeout=600, total_timeout=600, verbose=1):
    
    import os
    # import libct.explore as explore
    import libct.explore_no_coverage as explore
    ...
    if dump_projstats:
        statsdir = os.path.join("/home/jack/pyctlog", modpath, funcname)
    ...
    if execute is None:
        print("The target function is not found!")
        return None
    ...
    result = engine.explore(
        modpath, in_dict, root=root, funcname=funcname, max_iterations=max_iter,
